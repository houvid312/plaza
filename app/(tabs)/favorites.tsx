...
const styles = StyleSheet.create({
  ...
  guestIconWrap: { width: 90, height: 90, borderRadius: 28, backgroundColor: '#FFF1F2', alignItems: 'center', justifyContent: 'center', marginBottom: 20 },
  guestEmoji: { fontSize: 44, color: '#F43F5E' },
  guestTitle: { fontSize: 24, fontWeight: '800', color: '#0F0A2A', marginBottom: 8, letterSpacing: -0.3 },
  guestText: { fontSize: 15, color: '#64748B', textAlign: 'center', lineHeight: 22, marginBottom: 36 },
  loginBtn: {
  ...
  registerBtn: {
    backgroundColor: '#F5F3FF', borderRadius: 16, paddingVertical: 16, paddingHorizontal: 40,
    width: '100%', alignItems: 'center', borderWidth: 1.5, borderColor: '#DDD6FE',
  },
